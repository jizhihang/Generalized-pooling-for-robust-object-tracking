function [A_pos, A_neg] = GetSamplesColor( image, affpara, template_size, pos_num, neg_num, affsig )
%
%
%
%% 得到pos_num个正样本
...
A_pos = WarpImgColor( image, all_affpara_mat, template_size );
...
A_neg = WarpImgColor( image, all_affpara_mat, template_size );
end
